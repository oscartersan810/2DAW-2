...
<body>
    ...
    <div class="formularios">
            <form action="" method="post">
                <h2>POR VASO</h2>
                <label for="Vaso">Por Vaso: </select>
                <select name="vaso" id="">
                    <option value="default" selected>Seleccionar...</option>
                    <option value="Cocktail_glass">Coctel</option>
                    <option value="Champagne_flute">Champane</option>
                </select><br><br>
    ...
    <?php
    if (isset($_REQUEST['vaso'])) {
        $direccion_api = "http://www.thecocktaildb.com/api/json/v1/1/filter.php?g=" . $_REQUEST['vaso'];
        ...
        if (!empty($cocktails['drinks'])) {
            ...
            echo "<p>No se encontraron cócteles por Vaso</p>";
        }
    }
