...
<body>
    ...
    <div class="formularios">
            <form action="" method="post">
                <h2>POR CATEGORIA</h2>
                <label for="Categoria">Por Categoria: </select>
    ...
    if (isset($_REQUEST['categoria'])) {
        $direccion_api = "http://www.thecocktaildb.com/api/json/v1/1/filter.php?c=" . $_REQUEST['categoria'];
        ...
        if (!empty($cocktails['drinks'])) {
            ...
            echo "<p>No se encontraron cócteles por Categoria</p>";
        }
    }
