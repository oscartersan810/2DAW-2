describe('Parking', () => {
    ...
    // Comprobamos que detecta correctamente que una plaza está libre
    it('Debería devolver que la plaza 5 está libre', () => {
      parking.entradaVehiculo('8025JHH', 1, '05/11/2023 11:35');
      parking.entradaVehiculo('2025AZH', 3, '05/11/2023 12:15');
      expect(parking.comprobarPlazaLibre(5)).toEqual(true);
    });
  
    // Comprobamos que detecta correctamente que una plaza está ocupada
    it('Debería devolver que la plaza 3 está ocupada', () => {
      parking.entradaVehiculo('8025JHH', 1, '05/11/2023 11:35');
      parking.entradaVehiculo('2025AZH', 3, '05/11/2023 12:15');
      expect(parking.comprobarPlazaLibre(3)).toEqual(false);
    });
    ...
    it('La matrícula del vehículo que sale de la plaza 7 debería ser 8025JHH', () => {
      ...
      // Comprobamos que tras la salida de un vehículo la plaza que ocupaba queda libre
      it('La plaza debe quedar libre cuando sale un vehículo', () => {
        parking.entradaVehiculo('8025JHH', 7, '05/11/2023 14:30');
        const salida = parking.salidaVehiculo(7, '05/11/2023 15:42');
        expect(parking.comprobarPlazaLibre(7)).toBe(true);
      });
